...
public class PlanActivityForProduce extends BaseActivity implements IPlanView {
...
//        orderTrackPoster.postOrderTrack("获取订单");
        ...
        //产品名称标题
        StringBuilder productTitle = new StringBuilder(productName);
        tvProductTitle.setText(productTitle.toString());
        //产品流程
        productProcessPresenter.getPlan(productName);
    ...
    private void init() {
        ...
        pDialog = new SweetAlertDialog(PlanActivityForProduce.this);
        fab = $(R.id.fab);
    ...
    public void planResult(final List<ProductProcess> productProcesses) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PlanActivityForProduce.this, ReCheckMaterialProcessActivity.class);
